...
if("TRUE" STREQUAL "TRUE")
  set(neato_driver_SOURCE_PREFIX /home/parallels/catkin_ws/src/robot17/neato_robot/neato_driver)
  set(neato_driver_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  ...
  set(neato_driver_INSTALL_PREFIX /home/parallels/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/robot17/neato_robot/neato_driver/${idir}'.  ${_report}")
    endif()
