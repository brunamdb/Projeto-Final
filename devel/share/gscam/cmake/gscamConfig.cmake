...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/parallels/catkin_ws/src/robot17/gscam)
  set(gscam_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/parallels/catkin_ws/install)
...
if(NOT "/home/parallels/catkin_ws/src/robot17/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/parallels/catkin_ws/src/robot17/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Russell Toris <rctoris@wpi.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/robot17/gscam/${idir}'.  ${_report}")
    endif()
